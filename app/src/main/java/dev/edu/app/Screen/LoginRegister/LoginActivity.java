                    ...
                    if(snapshot.exists()){
                        ...
                        if(pass.equals(password)){
                            ...
                            new Handler().postDelayed(() -> {
                                ...
                                startActivity(new android.content.Intent(LoginActivity.this, dev.edu.app.Screen.Home.HomeActivity.class));
                                finish();
                            }, 1000L);
                        }else{
                            WaitDialog.dismiss();
                        ...
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            if (doctorsModel != null && doctorsModel.getDoctorId().equals(token)) {
                                ...
                                new Handler().postDelayed(() -> {
                                    ...
                                    startActivity(new android.content.Intent(LoginActivity.this, dev.edu.app.Screen.Home.MessActivity.class));
                                    finish();
                                }, 1000L);
                            }
                        }
